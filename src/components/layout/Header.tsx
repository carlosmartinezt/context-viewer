...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-[var(--color-bg-elevated)] border-b border-[var(--color-border-subtle)] z-20">
      <div className="flex items-center justify-between h-full px-4 lg:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold text-[var(--color-text)] tracking-tight" style={{ fontFamily: 'var(--font-display)' }}>
            Context Viewer
          </h1>
        </div>
